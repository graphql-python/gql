...
class FakeCredentials(object):
    def __init__(self, access_key=None, secret_key=None, method=None, token=None, region=None):
...
def fake_credentials_factory():
    def _fake_credentials_factory(access_key=None, secret_key=None, method=None, token=None, region=None):
        return FakeCredentials(access_key=access_key, secret_key=secret_key, method=method, token=token, region=region)
